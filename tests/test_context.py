"""Tests for locus.context -- system prompt assembly."""
...
from locus.context import build_context, _first_paragraph, _resolve_wikilinks
from locus.priorities import Priorities, Task, ProjectInfo
